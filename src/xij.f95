...
!@-node:gcross.20090805153643.1842:wrap_around
!@+node:gcross.20090805093617.1833:vpi_update_xij
subroutine vpi_update_xij( xij2, x, sl_start, sl_end, N_SLICES, N_PARTICLES, N_DIMENSIONS )
...
!@-node:gcross.20090805093617.1833:vpi_update_xij
!@+node:gcross.20090805093617.1834:vpi_update_xij_pbc
subroutine vpi_update_xij_pbc( xij2, x, period_length, sl_start, sl_end, N_SLICES, N_PARTICLES, N_DIMENSIONS )
  integer, intent(in) :: N_SLICES, N_PARTICLES, N_DIMENSIONS
  integer, intent(in) :: sl_start, sl_end
  double precision, dimension ( N_SLICES, N_PARTICLES , N_PARTICLES ), intent(inout) :: xij2
  double precision, dimension ( N_SLICES, N_PARTICLES , N_DIMENSIONS ), intent(in) :: x
