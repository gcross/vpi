C@+leo-ver=4-thin
C@+node:gcross.20090914154930.1877:@thin fresnel.f
C@@language fortran

C@+others
C@+node:gcross.20090914154930.1879:Documentation
...
C@nonl
C@-node:gcross.20090914154930.1879:Documentation
C@+node:gcross.20090914154930.1878:Interface
...
C@-node:gcross.20090914154930.1878:Interface
C@+node:gcross.20090914154930.1880:Implementation
C@+node:gcross.20090914154930.1882:d1mach
...
C     Returns the value of TEST1 - 1.
      ...
      END
C@-node:gcross.20090914154930.1882:d1mach
C@+node:gcross.20090914154930.1886:dcospx
...
C
   30 continue
      ...
      END
C@-node:gcross.20090914154930.1886:dcospx
C@+node:gcross.20090914154930.1883:dcspxx
...
C@-node:gcross.20090914154930.1883:dcspxx
C@+node:gcross.20090914154930.1887:derm1
...
C
      ...
      END
C@-node:gcross.20090914154930.1887:derm1
C@+node:gcross.20090914154930.1890:derv1
...
C
      END
C@-node:gcross.20090914154930.1890:derv1
C@+node:gcross.20090914154930.1881:dfren1
...
C@-node:gcross.20090914154930.1881:dfren1
C@+node:gcross.20090914154930.1885:dsinpx
...
C
   30 IF (X .LT. 0.0D0) DSINPX = - DSINPX
      ...
      END
C@-node:gcross.20090914154930.1885:dsinpx
C@+node:gcross.20090914154930.1884:dsnpxx
...
C@-node:gcross.20090914154930.1884:dsnpxx
C@+node:gcross.20090914154930.1889:erfin
      SUBROUTINE ERFIN
C     .  Copyright (C) 1989, California Institute of Technology.
C     .  U. S. Government sponsorship under
C     .  NASA contract NAS7-918 is acknowledged.
...
C
 1003 FORMAT(1X,72('$')/' ')
      ...
      END
C@-node:gcross.20090914154930.1889:erfin
C@+node:gcross.20090914154930.1888:ermsg
