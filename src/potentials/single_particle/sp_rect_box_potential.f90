!@+leo-ver=4-thin
!@+node:gcross.20090624094338.1367:@thin sp_rect_box_potential.f90
!@@language fortran90
module sp_rect_box_potential
  ...
  real (kind=b8), private :: x_length, y_length, z_length
  !@-node:gcross.20090624094338.1372:<< Variables >>
  !@nl
...
contains
  ...
  !@+others
  !@+node:gcross.20090624094338.1370:init_sp
  subroutine init_sp ()
    namelist /single_particle_configuration/ x_length, y_length, z_length
...
end module sp_rect_box_potential
!@-node:gcross.20090624094338.1367:@thin sp_rect_box_potential.f90
!@-leo
