!@+leo-ver=4-thin
!@+node:gcross.20090624144408.1743:@thin tb_dimer_Z_polarized_with_hard_sphere_potential.f90
!@@language fortran90
module tb_dimer_Z_polarized_with_hard_sphere_potential
...
contains
  ...
  !@  << Subroutines >>
  !@+node:gcross.20090624144408.1746:<< Subroutines >>
  !@+others
  !@+node:gcross.20090624144408.1747:init_tb_potential
  ...
  !@-node:gcross.20090624144408.1747:init_tb_potential
  !@+node:gcross.20090624144408.1748:Uij
  ...
  !@-node:gcross.20090624144408.1748:Uij
  !@+node:gcross.20090624144408.1749:gUij
  function gUij_func( x, xij2, sl, nslice, np, ndim ) result ( gUij )
    real(kind=b8), dimension ( nslice, np , ndim ) :: x
    real(kind=b8), dimension ( nslice, np , np ) :: xij2
...
end module tb_dimer_Z_polarized_with_hard_sphere_potential
!@-node:gcross.20090624144408.1743:@thin tb_dimer_Z_polarized_with_hard_sphere_potential.f90
!@-leo
